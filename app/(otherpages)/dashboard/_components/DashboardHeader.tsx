...
export default function DashboardHeader() {
  ...
  return (
    <Card className="bg-gradient-to-r  from-pink-600/20 via-indigo-800 to-purple-600/20 border-none">
      <CardContent className="p-6 flex flex-row justify-between items-center gap-4">
        ...
        <Button
          ...
          className="max-sm:size-sm md:p-6 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold shadow-md transition-all"
